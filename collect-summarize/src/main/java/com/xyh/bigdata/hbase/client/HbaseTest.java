package com.xyh.bigdata.hbase.client;
...
public class HbaseTest {
    /*
     * Hbase客户端配置信息:
     *  Hbase客户端需要有一份HBase配置信息来访问HBase --zookeeper quorum 地址.
     *  configuration.set("hbase.zookeeper.quorum", "192.168.1.100");
     * HBase配置信息可以通过两种方式获取：
     *  1.java客户端从类路径里的 hbase-site.xml文件里面获取配置信息.
     *  2.通过在连接中显示设定配置信息来获取.
     *
     */
    ...
    static {
        ...
        configuration.set("hbase.zookeeper.quorum", "39.106.213.40");
